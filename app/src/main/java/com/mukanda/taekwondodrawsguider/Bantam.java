...
public class Bantam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bantam);
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                switch (i){
                    case R.id.radioMale:
                        Toast.makeText(Bantam.this,"male",Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.radioFemale:
                        Toast.makeText(Bantam.this,"female",Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        });
                            ...
                            FirebaseDatabase.getInstance().getReference().child("middle_heavy").setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        ...
                                        ReusableFunctionsAndObjects.showMessageAlert(Bantam.this, "Completed", "Mr "+FullName+" You have successfully Registered for this Championship "+". Check status about your draw after some time.", "OK",(byte)1);
                                    }else{
                                        progressDialog.dismiss();
                                        ReusableFunctionsAndObjects.showMessageAlert(Bantam.this, "Completed", "Mr "+FullName+" You have successfully Registered for this Championship "+". Check status about your draw after some time.", "OK",(byte)1);
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    progressDialog.dismiss();
                                    ReusableFunctionsAndObjects.showMessageAlert(Bantam.this, "Network Error", "Make sure you are connected to internet.", "OK",(byte)0);
                                }
                            });
                        }else{
                            progressDialog.dismiss();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Bantam.this,PlayerLoginRegisterChoice.class));
