...
public class Fly_weight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                switch (i){
                    case R.id.radioMale:
                        Toast.makeText(Fly_weight.this,"male",Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.radioFemale:
                        Toast.makeText(Fly_weight.this,"female",Toast.LENGTH_SHORT).show();
                        break;
                }
            }
        });
                            ...
                            FirebaseDatabase.getInstance().getReference().child("middle_heavy").setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        ...
                                        ReusableFunctionsAndObjects.showMessageAlert(Fly_weight.this, "Completed", "Mr "+FullName+" You have successfully Registered for this Championship "+". Check status about your draw after some time.", "OK",(byte)1);
                                    }else{
                                        progressDialog.dismiss();
                                        ReusableFunctionsAndObjects.showMessageAlert(Fly_weight.this, "Completed", "Mr "+FullName+" You have successfully Registered for this Championship "+". Check status about your draw after some time.", "OK",(byte)1);
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    progressDialog.dismiss();
                                    ReusableFunctionsAndObjects.showMessageAlert(Fly_weight.this, "Network Error", "Make sure you are connected to internet.", "OK",(byte)0);
                                }
                            });
                        }else{
                            progressDialog.dismiss();
    ...
    public void onBackPressed() {
        startActivity(new Intent(Fly_weight.this,PlayerLoginRegisterChoice.class));
