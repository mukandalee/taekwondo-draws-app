...
public class PlayerRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goToLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(PlayerRegister.this, LoginActivity.class).putExtra("ForAthlete",true));
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isValid()){
                    ...
                    progressDialog.show();
                    FirebaseAuth.getInstance().createUserWithEmailAndPassword(email,pass).addOnCompleteListener(PlayerRegister.this, new OnCompleteListener<AuthResult>() {
                        @Override
                            ...
                            if (task.isSuccessful()) {
                                FirebaseAuth.getInstance().getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                       ...
                                       // ccp.getSelectedCountryCodeWithPlus()+mobileNo);
                                        ...
                                        FirebaseDatabase.getInstance().getReference().child("UserDetails").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                ReusableFunctionsAndObjects.showMessageAlert(PlayerRegister.this, "Partially Completed", "To complete the registration click the verification link sent to you email ("+email+").","OK", (byte) 1);
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                ...
                                                ReusableFunctionsAndObjects.showMessageAlert(PlayerRegister.this, "Network Error", "Could'nt register, Please make sure you are connected with internet","OK", (byte) 0);
                                            }
                                        });
                                    }
                                } ).addOnFailureListener(new OnFailureListener() {
                                ...
                                try {
                                    ...
                                    progressDialog.dismiss();
                                    ReusableFunctionsAndObjects.showMessageAlert(PlayerRegister.this, "Weak Password", "Your password is weak","OK", (byte) 0);
                                } catch (FirebaseAuthUserCollisionException existEmail) {
                                    progressDialog.dismiss();
                                    ReusableFunctionsAndObjects.showMessageAlert(PlayerRegister.this, "Error in Registration",  "This email is already registered","OK", (byte) 0);
                                } catch (Exception e) {
                                    progressDialog.dismiss();
                                    ReusableFunctionsAndObjects.showMessageAlert(PlayerRegister.this, "Network Error", "Could'nt register, Please make sure you are connected with internet","OK", (byte) 0);
                                }
    ...
    public void onBackPressed() {
        startActivity(new Intent(PlayerRegister.this,PlayerLoginRegisterChoice.class));
